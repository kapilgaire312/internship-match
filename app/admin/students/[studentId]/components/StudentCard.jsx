    ...
    <div className=" flex flex-col  bg-white px-4 py-6 rounded-lg shadow-sm gap-6">
      ...
      <div className="flex flex-col items-center ">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">Batch {studentDetails.batch_year || "--"}</p>
      ...
      <div className="flex flex-col gap-2 ">
        ...
        <div className="flex justify-between items-center border-b py-2 w-40">
          <div className="flex gap-1 text-gray-500">
            <Image
          ...
          <p className="break-all text-wrap">{studentDetails.address || "--"}</p>
        </div>
        <div className="flex justify-between items-center border-b py-2 w-40">
          <div className="flex gap-1 text-gray-500">
            <Image
          ...
          <p className="break-all text-wrap">{studentDetails.university || "--"}</p>
        </div><div className="flex justify-between items-center border-b py-2 w-40">
          <div className="flex gap-1 text-gray-500">
            <Image
          ...
          <p className="break-all text-wrap">{studentDetails.joined_at?.toLocaleDateString("en-US", {
            year: "numeric",
            month: "long",
            day: "numeric",
          }) || "N/A"}</p>
